...
let Boton1 = document.getElementById("BotonCerrar");
    ...
    if (NuevaY < y + AltoTrazo) {
      ...
      function DibujarPetalosTallo() {
        if (CuantosPasos <= Pasos) {
          ...
          DibujarPetalo(200, PetaloY, 15, 2, 300, "green", CuantosPasos);
          DibujarPetalo(170, PetaloY2, 15, 2, 300, "green", CuantosPasos);
          CuantosPasos++;
...
function CrearVarias() {
  ...
  const espacioX = canvas.width / 1;
  const espacioY = 600 / 3;
